...
## Overview
REST API contract for the stateless chat endpoint that enables conversational todo management through an AI agent.
...
4. Persist the user's message to the database
5. Load conversation history from database
6. Process message through AI agent with conversation context
7. Persist AI's response to the database
...
```json
{
  ...
  "created_at": "string (ISO 8601 datetime)",
  "updated_at": "string (ISO 8601 datetime)",
  "tool_calls": "object (nullable, JSON containing tool call information)",
  "tool_results": "object (nullable, JSON containing tool result information)",
