...
files_yaml:
  ...
  - "Dockerfile"
  - "app.py"
  - "history/prompts/chat-api-endpoint/5-chat-endpoint-implementation-complete.green.prompt.md"
tests_yaml: []
---
